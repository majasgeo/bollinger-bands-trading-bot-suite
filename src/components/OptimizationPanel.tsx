...
export function OptimizationPanel({
  ...
  const totalCombinations = isSecondsTimeframe
    ? 12 * 4 * 3 * 13  // Smaller SMA range for seconds
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-4">
          ...
          <div className="text-xs text-gray-500 space-y-1 mb-4">
            {isSecondsTimeframe ? (
              <>
                <p>• <strong>SMA:</strong> 2 to 20 periods (12 values) - optimized for seconds data</p>
                <p>• <strong>StdDev:</strong> 1.0, 1.5, 2.0, 2.5 (4 values)</p>
                <p>• <strong>Offset:</strong> 0, 2, 5 (3 values)</p>
                <p>• <strong>Leverage:</strong> 2x to 125x (13 values)</p>
                <p>• <strong>Total:</strong> {(12 * 4 * 3 * 13).toLocaleString()} combinations</p>
              </>
            ) : (
              <>
